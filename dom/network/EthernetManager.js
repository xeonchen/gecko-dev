...
EthernetInterface.prototype = {
  ...
  updateConfig: function(config) {
    ...
    this.info.httpProxyHost = (config.httpProxyHost != undefined) ?
                          config.httpProxyHost : this.info.httpProxyHost;
    this.info.httpProxyPort = (config.httpProxyPort != undefined) ?
                          config.httpProxyPort : this.info.httpProxyPort;
